...
export default function InvestigationReasoningCard({ reasoning }: InvestigationReasoningCardProps) {
  return (
    <div className="bg-[#EC4899]/5 rounded-xl shadow-lg border border-[#EC4899]/25 p-6 mb-8 min-w-0">
      <div className="flex items-start min-w-0">
        <div className="flex-shrink-0 mt-1">
          <svg className="w-6 h-6 text-[#EC4899] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
