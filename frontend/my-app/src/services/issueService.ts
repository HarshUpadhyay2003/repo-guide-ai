...
export const getIssueDetails = async (issueId: string): Promise<IssueDetail | null> => {
  // Simulating an asynchronous fetch using the static mock data 
  // Based on sample_posthog_analysis.json context
  return {
